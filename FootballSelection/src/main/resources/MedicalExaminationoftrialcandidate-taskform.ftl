<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("medicalScore");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isNumeric(myInputs[j])) {
							alert("Please enter valid medicalScore");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: selectionProcess.MedicalExaminationoftrialcandidate
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">medicalScore</label>
                            		<div class="div_texbox">
                              		<input name="medicalScore" type="text" class="textbox" id="medicalScore" value="${medicalScore}" />
                            		</div>
