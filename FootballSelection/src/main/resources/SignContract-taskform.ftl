<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("Accepted");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid Accepted");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: selectionProcess.SignContract
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox">HR, Player</div>
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<label for="name">in_salary</label>
                            		<div class="div_checkbox">
                              		${in_salary}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_checkbox">
                              		<input name="Accepted" type="checkbox" class="checkbox" id="Accepted" value="${Accepted}" />
                            		</div>
