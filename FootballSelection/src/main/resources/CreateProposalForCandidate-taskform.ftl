<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("salary");
					i++;
...
<div id="container">
	<div id="header">
		User Task Form: selectionProcess.CreateProposalForCandidate
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox">HR, Technical Director</div>
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<label for="name">in_medicalScore</label>
                            		<div class="div_checkbox">
                              		${in_medicalScore}
                            		</div>
                            		<label for="name">in_pScore</label>
                            		<div class="div_checkbox">
                              		${in_pScore}
                            		</div>
                            		<label for="name">in_fScore</label>
                            		<div class="div_checkbox">
                              		${in_fScore}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="salary" type="text" class="textbox" id="salary" value="${salary}" />
                            		</div>
