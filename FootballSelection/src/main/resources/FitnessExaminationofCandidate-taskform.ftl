<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("fitnessScore");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isNumeric(myInputs[j])) {
							alert("Please enter valid fitnessScore");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: selectionProcess.FitnessExaminationofCandidate
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox">admin, Fitness Examiner </div>
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">fitnessScore</label>
                            		<div class="div_texbox">
                              		<input name="fitnessScore" type="text" class="textbox" id="fitnessScore" value="${fitnessScore}" />
                            		</div>
